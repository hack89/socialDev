...
const EditProfile = ({profile: {profile, loading}, getCurrentProfile, createProfile, history}) => {
    ...
    return (
      ...
      <form className="form"  onSubmit={(e)=>onSubmit(e)}>
        ...
        <div className="my-2">
          <button type="button" onClick={()=> toggleSociaInputs(!displaySocialInputs)} className="btn btn-light">
        ...
        <div className="form-group social-input">
          ...
          <input type="text" placeholder="Instagram URL"  value={instagram} onChange={e => onChange(e)} name="instagram" />
        </div>
