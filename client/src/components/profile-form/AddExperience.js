    ...
    return (
      ...
      <form className="form" onSubmit={e => {e.preventDefault(); addExperience(formData, history)}}>
        ...
        <div className="form-group">
         ...
         <div className="form-group">
          <p><input type="checkbox" checked={current} value={current} onChange={e => {setFormData({...formData, current: !current}); toggleDisabled(!toDateDisabled)}}  name="current" /> {' '}Current Job</p>
        </div>
        <div className="form-group">
          <h4>To Date</h4>
